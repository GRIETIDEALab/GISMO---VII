...
Firebase.setFloat(firebaseData,"GRIET_IDEALab/Environment_Monitor/Temperature",tempC);
...
Serial.println(" hPa");
Firebase.setFloat(firebaseData,"GRIET_IDEALab/Environment_Monitor/Pressure",atPressure);
...
Serial.print(altitude);
Serial.println(" m");
Firebase.setFloat(firebaseData,"GRIET_IDEALab/Environment_Monitor/Altitude",altitude);
Serial.println();
Firebase.setFloat(firebaseData,"GRIET_IDEALab/Environment_Monitor/Humidity",0.0);
