...
void mpu_record(){
  ...
  Firebase.setString(firebaseData,"GRIET_IDEALab/Fall_Detector/Position",position);
  display.clear();
...
String fdCloudFull;
String fdCloud;
if(Firebase.getString(firebaseData,"GRIET_IDEALab/Fall_Detector/Limit",fdCloudFull)){
